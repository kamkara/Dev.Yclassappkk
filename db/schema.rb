...
ActiveRecord::Schema[7.0].define(version: 2022_11_21_171323) do
  ...
  create_table "citytwons", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "title"
    t.string "slug"
    t.uuid "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_citytwons_on_user_id"
  end
  ...
  add_foreign_key "citytwons", "users"
